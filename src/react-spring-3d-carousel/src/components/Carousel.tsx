...
import leftNavigation from "../static/left_white.png";
import rightNavigation from "../static/right_white.png";
...
class Carousel extends Component<IProps, IState> {
  ...
  moveSlide = (direction: -1 | 1) => {
    const index = this.modBySlidesLength(this.state.index + direction);
    this.setState({
      index,
      goToSlide: null,
    });
